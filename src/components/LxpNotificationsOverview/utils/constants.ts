export const NOTIFICATION_ACTION_TYPES = {
  ...
  UpdateLearningPathAdmin: 'NOTIFICATION_UPDATE_LEARNING_PATH_ADMIN',
  ...
  SessionCreated: 'NOTIFICATION_EVENT_SESSION_CREATED',
  SessionDateUpdated: 'NOTIFICATION_EVENT_SESSION_DATE_UPDATE',
  SessionUpdated: 'NOTIFICATION_EVENT_SESSION_UPDATED',
  SessionCancelled: 'NOTIFICATION_EVENT_SESSION_CANCELLED',
  InstructorAddedtoEventSession:
    'NOTIFICATION_INSTRUCTOR_ADDED_TO_EVENT_SESSION',
  ...
  EventCompletionConfirmed: 'NOTIFICATION_ALL_EVENT_SESSIONS_COMPLETED',
  EventSessionReminder: 'NOTIFICATION_EVENT_SESSION_REMINDER',
  LearnerEnrolledToEventSession: 'NOTIFICATION_EVENT_ASSIGNMENT',
  LearnerEnrolledToAllEventSessions:
    'NOTIFICATION_EVENT_ASSIGNMENT_ALL_SESSIONS',
  ...
  UpdateSharedPathVersion: 'NOTIFICATION_UPDATE_SHARED_LEARNING_PATH_VERSION',
  ...
  AssignedReporteesSummary: 'NOTIFICATION_ON_ASSIGNED_REPORTEES_SUMMARY',
  CompletedReporteesSummary: 'NOTIFICATION_ON_COMPLETED_REPORTEES_SUMMARY',
  AssignedTeamMembersSummary: 'NOTIFICATION_ON_ASSIGNED_TEAM_MEMBERS_SUMMARY',
  CompletedTeamMembersSummary: 'NOTIFICATION_ON_COMPLETED_TEAM_MEMBERS_SUMMARY',
  ...
  SystemGenerated: [
    ...
    'NOTIFICATION_EVENT_SESSION_CREATED',
    'NOTIFICATION_EVENT_SESSION_DATE_UPDATE',
    'NOTIFICATION_EVENT_SESSION_UPDATED',
    'NOTIFICATION_EVENT_SESSION_CANCELLED',

    'NOTIFICATION_EVENT_ASSIGNMENT',
    'NOTIFICATION_EVENT_ASSIGNMENT_ALL_SESSIONS',
    'NOTIFICATION_INSTRUCTOR_ADDED_TO_EVENT_SESSION',
    'NOTIFICATION_EVENT_SESSION_REMINDER',
    'NOTIFICATION_ALL_EVENT_SESSIONS_COMPLETED',
  ],
