...
export const ModernFilter = props => (
  <svg width={props.width} height={props.height} viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="M12.2 33H21.8C29.8 33 33 29.8 33 21.8V12.2C33 4.2 29.8 1 21.8 1H12.2C4.2 1 1 4.2 1 12.2V21.8C1 29.8 4.2 33 12.2 33Z" fill={props.color} stroke="#DDDDDD" strokeLinecap="round" strokeLinejoin="round" />
