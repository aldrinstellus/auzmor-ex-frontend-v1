...
export const AssesmentLimitExceededSVG = props => (
  <React.Fragment>
    <svg height={props.height} width={props.width} viewBox="0 -2 512 512" {...props}>
      <path d="m448 508.800781-148.59375-92.800781h-267.40625c-17.671875 0-32-14.328125-32-32v-352c0-17.671875 14.328125-32 32-32h448c17.671875 0 32 14.328125 32 32v352c0 17.671875-14.328125 32-32 32h-32zm0 0" fill={props.color} />
      <g fill="#fff">
