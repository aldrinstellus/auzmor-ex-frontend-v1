...
const SvgEditFilled = ({
  ...
  >
    ...
    />
    <path
      d="M15.61 11.53C15.32 11.39 15.04 11.25 14.77 11.09C14.55 10.96 14.34 10.82 14.13 10.67C13.96 10.56 13.76 10.4 13.57 10.24C13.55 10.23 13.48 10.17 13.4 10.09C13.07 9.81 12.7 9.45 12.37 9.05C12.34 9.03 12.29 8.96 12.22 8.87C12.12 8.75 11.95 8.55 11.8 8.32C11.68 8.17 11.54 7.95 11.41 7.73C11.25 7.46 11.11 7.19 10.97 6.91C10.9488 6.8646 10.9283 6.81944 10.9085 6.77453C10.7609 6.44122 10.3262 6.34377 10.0685 6.60153L4.34001 12.33C4.21001 12.46 4.09001 12.71 4.06001 12.88L3.52001 16.71C3.42001 17.39 3.61001 18.03 4.03001 18.46C4.39001 18.81 4.89001 19 5.43001 19C5.55001 19 5.67001 18.99 5.79001 18.97L9.63001 18.43C9.81001 18.4 10.06 18.28 10.18 18.15L15.9013 12.4287C16.1609 12.1691 16.063 11.7237 15.7254 11.5796C15.6874 11.5634 15.6489 11.5469 15.61 11.53Z"
      fill={fill}
    />
  </svg>
);
